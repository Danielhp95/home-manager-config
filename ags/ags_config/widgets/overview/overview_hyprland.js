...
export default () => {
    ...
    const Window = ({ address, at: [x, y], size: [w, h], workspace: { id, name }, class: c, title, xwayland }, screenCoords) => {
        ...
        return Widget.Button({
            ...
            `,
            onClicked: (self) => {
                Hyprland.message(`dispatch focuswindow address:${address}`);
                App.closeWindow('overview');
            },
            onMiddleClickRelease: () => Hyprland.message(`dispatch closewindow address:${address}`),
                ...
                const menu = Widget.Menu({
                    ...
                    children: [
                        Widget.MenuItem({
                            ...
                            onActivate: () => Hyprland.message(`dispatch closewindow address:${address}`),
                        }),
    ...
    const Workspace = (index) => {
        ...
        const widget = Widget.Box({
            ...
            children: [Widget.EventBox({
                ...
                vexpand: true,
                onPrimaryClick: () => {
                    Hyprland.message(`dispatch workspace ${index}`)
                    App.closeWindow('overview');
                },
                setup: (eventbox) => {
                    eventbox.drag_dest_set(Gtk.DestDefaults.ALL, TARGET, Gdk.DragAction.COPY);
                    eventbox.connect('drag-data-received', (_w, _c, _x, _y, data) => {
                        Hyprland.message(`dispatch movetoworkspacesilent ${index},address:${data.get_text()}`)
                        overviewTick.setValue(!overviewTick.value);
                    });
                },
                child: fixed,
    ...
    const OverviewRow = ({ startWorkspace, workspaces, windowName = 'overview' }) => Widget.Box({
        ...
        attribute: {
            ...
            update: (box) => {
                ...
                Hyprland.message('j/clients').then(clients => {
